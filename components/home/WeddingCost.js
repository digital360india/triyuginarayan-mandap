...
const WeddingCost = () => {
  return (
    <div className="max-w-[1400px] flex flex-col md:flex-row justify-between mt-25 md:h-[600px] m-auto px-0 md:px-10">
      <div className="w-full md:w-2xl p-0 md:p-10 mx-auto px-8 md:px-0 space-y-6">
      ...
      <div>
        <div className="h-[400px]">
          <div className="relative flex justify-center md:w-2xl">
            <div
              className={`absolute top-[80px] md:top-[100px] w-[300px] h-[300px] md:w-[500px] md:h-[500px] transition-transform duration-1600 ease-in-out z-20`}
            >
              <Image
                src={wedding_cost}
                alt="image"
