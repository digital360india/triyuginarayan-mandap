...
const AboutSection = () => {
  return (
    <div>
      <div className="flex flex-col md:flex-row md:gap-0 gap-10 m-auto max-w-[1440px] p-0 md:p-10">
        <div className="hidden w-[40%] md:flex justify-center">
          <Image src={about_us} alt="img" className="w-[28rem]" />
        </div>
        <div className="w-full md:w-[60%] flex flex-col gap-10 p-0 md:p-4 px-8 md:px-4">
          <div>
            <div className="flex items-center justify-center md:justify-start gap-4">
              <p className="text-[2.5rem] md:text-[3.5rem] text-[#C95D2F] font-bold">नमस्ते!</p>
              <div className="w-[2.5rem] h-[2.5rem] md:w-[3.5rem] md:h-[3.5rem] bg-[#C95D2F] rounded-full flex justify-center items-center">
                <Image
                  src={namaste_gif}
                  alt="gif"
                  className="w-[1.5rem] h-[1.5rem] md:w-[2.5rem] md:h-[2.5rem]"
                />
              </div>
              </div>
        ...
        <div className="flex md:hidden justify-center">
          <Image src={about_us} alt="img" className="w-[20rem] md:w-[28rem]" />
        </div>
      </div>
    </div>
  );
