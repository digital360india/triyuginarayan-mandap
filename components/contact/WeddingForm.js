  ...
  return (
    <div className="flex flex-col md:flex-row px-8 md:px-10 mb-25 mt-25 max-w-[1440px] w-full m-auto">
      <div className="w-full md:w-[50%] p-0 md:p-10 space-y-9">
        ...
        <p className="text-[1rem] md:text-lg text-justify md:text-start">
        ...
        >
          <div className="flex flex-col gap-4 mx-auto">
            ...
            <input
              ...
              name=""
              id=""
              className="bg-[#EBEBEB] p-4 w-[15rem] md:w-[31.8125rem] rounded-[7px] outline-none"
          ...
          <div className="flex flex-col md:flex-row gap-4 w-[15rem] md:w-[31.8125rem] mx-auto justify-between">
            <div className="flex flex-col gap-4 ">
              ...
              <input
                ...
                name=""
                id=""
                className="bg-[#EBEBEB] w-[15rem] p-4 rounded-[7px] outline-none uppercase"
                placeholder="date"
              />
            </div>
            <div className="flex flex-col gap-4 ">
          ...
          <div className="flex gap-4 w-[15rem] md:w-[31.8125rem] mx-auto">
            <div className="flex flex-col gap-4">
              <label htmlFor="" className="font-semibold">
                {" "}
               No. of stay night required{" "}
              </label>
              <input
                type="date"
                name=""
